...
sections:
  ...
  - block: markdown
    ...
    content:
      title: Overview
      text: |
        This line studies how the cytoskeleton relates to cell metabolism, as part of the lab's broader work on cytoskeleton remodeling in collective cell migration, cancer invasion and metabolism. The lab uses high-resolution respirometry (oxygraphy) to measure bioenergetic changes in 2D and 3D cellular models, including oxygen consumption and glycolytic activity.
    design:
      columns: '1'
      spacing:
